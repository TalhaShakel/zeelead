                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.apiResultedx =
                                      await UserSinginSupabaseCall.call(
                                    email:
                                        _model.emailAddressFieldController.text,
                                    password:
                                        _model.passwordFieldController.text,
                                  );
                                  if ((_model.apiResultedx?.succeeded ??
                                      true)) {
                                    ...
                                    FFAppState().update(() {
                                      FFAppState().AcessTolken = getJsonField(
                                        (_model.apiResultedx?.jsonBody ?? ''),
                                        r'''$..access_token''',
                                      ).toString();
                                    });
                                    ...
                                    if ((_model.apiResultrzh?.succeeded ??
                                        true)) {
                                      await showDialog(
                                        context: context,
                                    ...
                                    if ((_model.apiResultedx?.statusCode ??
                                            200) ==
                                        400) {
                                      await showDialog(
                                        context: context,
