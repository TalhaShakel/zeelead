...
import 'found_leads_model.dart';
export 'found_leads_model.dart';

class FoundLeadsWidget extends StatefulWidget {
  const FoundLeadsWidget({Key? key}) : super(key: key);

  @override
  _FoundLeadsWidgetState createState() => _FoundLeadsWidgetState();
}

class _FoundLeadsWidgetState extends State<FoundLeadsWidget> {
  late FoundLeadsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoundLeadsModel());
