...
import 'risky_leads_model.dart';
export 'risky_leads_model.dart';

class RiskyLeadsWidget extends StatefulWidget {
  const RiskyLeadsWidget({Key? key}) : super(key: key);

  @override
  _RiskyLeadsWidgetState createState() => _RiskyLeadsWidgetState();
}

class _RiskyLeadsWidgetState extends State<RiskyLeadsWidget> {
  late RiskyLeadsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RiskyLeadsModel());
  }
